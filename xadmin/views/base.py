...
class CommAdminView(BaseAdminView):
    ...
    def get_nav_menu(self):
        ...
        for model, model_admin in self.admin_site._registry.items():
            #print("convert string to menu shown", model._meta.verbose_name, capfirst(model._meta.verbose_name_plural), smart_text(capfirst(model._meta.verbose_name_plural)))
            if getattr(model_admin, 'hidden_menu', False):
                continue
            app_label = model._meta.app_label
            print("xxx", model._meta.app_label)
            app_icon = None
            model_dict = {
                #'title': smart_text(capfirst(model._meta.verbose_name)),
                'title': smart_text(model._meta.verbose_name),
